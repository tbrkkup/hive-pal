...
|---|-------|----------|--------|------------|
| 1 | Open Settings → General | New "First day of week" and "Time format" selects appear directly after "Date Format" | PASS | `A1-settings-default.png` |
| 2 | Set First day of week = Monday, Time format = 12-hour; Save | Selects show "Monday" / "12-hour (5:00 PM)"; save succeeds | PASS | `A2-settings-monday-12h.png` |
| 3 | Open Inspections list (12h active) | Times render 12-hour: `7:05 PM`, `9:30 AM`, `5:00 PM`, `12:00 AM` | PASS | `A3-inspections-12h.png` |
| 4 | Set First day of week = Sunday, Time format = 24-hour; Save; open list | Times render 24-hour: `19:05`, `09:30`, `17:00`, `00:00` | PASS | `A6-inspections-24h.png` |
| 5 | With Monday preference, open month calendar (/calendar) | Weekday header starts with **Mo** (Mo Tu We Th Fr Sa Su) | PASS | `A9-calendar-monday.png` |
| 6 | With Sunday preference, open month calendar | Weekday header starts with **Su** (Su Mo Tu We Th Fr Sa) | PASS | `A10-calendar-sunday.png` |
